...
function myTwitter(){
	...
	//this sets the variable params to search the username vbmack and only return back the last 20 tweets and then it doesn't trim the username so the username information will come up instead of the twitter id#
	var params = {
		screen_name: 'vbmack',
		count: '20',
		trim_user: false,
